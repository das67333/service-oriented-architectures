...
impl App {
    ...
    pub async fn run(&self) {
        ...
        let app = Router::new()
            ...
            .route("/update_post/:id", put(handlers::update_post))
            .route("/remove_post/:id", delete(handlers::remove_post))
            .route("/get_post/:id", get(handlers::get_post))
            .route("/get_posts", get(handlers::get_posts))
